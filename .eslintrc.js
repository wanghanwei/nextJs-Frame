module.exports = {
  ...
  parserOptions: {
    ecmaVersion: 2018, // -set to 3, 5 (default), 6, 7, 8, 9, or 10 to specify the version of ECMAScript syntax you want to use. You can also set to 2015 (same as 6), 2016 (same as 7), 2017 (same as 8), 2018 (same as 9), or 2019 (same as 10) to use the year-based naming
    sourceType: 'module',
    impliedStrict: true,
    ecmaFeatures: {
      jsx: true, // -enable JSX
  ...
  plugins: ['prettier', 'babel', '@typescript-eslint', 'react', 'react-hooks'],
  overrides: [
    {
      files: ['*.ts', '*.tsx'],
      rules: {
  ...
  rules: {
    ...
    'id-length': 0, //变量名长度
    // indent: ['error', 2, { SwitchCase: 1 }], //缩进风格he prettier冲突
    ...
    // 'operator-linebreak': [2, 'after'], //换行时运算符在行尾还是行首 prettier冲突
    ...
    memberSyntaxSortOrder: [0, 'all', 'multiple', 'single'],
  },
};
